...
| 赋值       | 2    | `$赋值 变量名 值或表达式$`                                                           | 非阻断函数 | 自定义一个变量并给他对应的值                 | `$赋值 A 字符串$`<br>`$赋值 B 1$` <br/> `$赋值 C [2*%B%+%QQ%$]`                                                                                                                                                                                               |
| 删除       | 1    | `$删除 变量名$`                                                                 | 非阻断函数 | 删除一个变量                         | `$删除 A$`                                                                                                                                                                                                                                             |
| 随机数      | 2    | `$随机数 变量名 最小值 最大值$`                                                        | 非阻断函数 | 生成一个随机数并存放到变量名中(左闭右开区间)        | `$随机数 A 1 3$`                                                                                                                                                                                                                                        |
| 检验变量     | 2    | `$检验变量 存入变量 要检验的变量$`                                                       | 非阻断函数 | 检验要检验的变量是否存在。并将结果存入变量中         | `$检验变量 B A$`(把A的检验结果放进B中)                                                                                                                                                                                                                            |
