...
public abstract class IFEKitLog {
    ...
    public abstract void i(String str, int i2, String str2);

    public abstract void v(String str, int i2, String str2);

    public abstract void w(String str, int i2, String str2);
}